...
class ProdConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = '{{ doorman_sqlalchemy_database_uri }}'

    DOORMAN_ENROLL_SECRET = ['{{ doorman_secret_key }}']
    DOORMAN_MINIMUM_OSQUERY_LOG_LEVEL = 1

    BROKER_URL = '{{ doorman_redis_uri }}'
    CELERY_RESULT_BACKEND = '{{ doorman_redis_uri }}'
